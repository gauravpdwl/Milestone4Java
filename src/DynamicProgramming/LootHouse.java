...
//		//Iterative Dynamic Programming(IDP) solution
...
//    	}
    	...
    	public static int maxMoneyLooted(int houses[]) {
    		...
    		*/
    		...
    		int output=helper(houses, 0);
    		return output;
    	}
    	
    	public static int helper(int houses[], int index) {
    		if(index>=houses.length) {
    			return 0;
    		}
    		
    		int output1=houses[index]+helper(houses, index+2);
    		int output2=helper(houses, index+1);
